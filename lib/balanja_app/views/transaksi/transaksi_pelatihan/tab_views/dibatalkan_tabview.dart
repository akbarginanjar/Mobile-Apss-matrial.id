...
// import 'package:mobile_balanja_id/balanja_app/views/transaksi/dibatalkan_pelatihan_card.dart';
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              children: [
                ...
                Center(
                  child: Text(
                    'Tidak ada transaksi Pelatihan Dibatalkan.',
              ...
              children: [
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // return DibatalkanPelatihanCard(transaksi: transaksi);
                  },
                ),
              ],
            ),
